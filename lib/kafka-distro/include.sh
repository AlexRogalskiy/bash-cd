...
export KAFKA_PACKAGE="kafka_2.12-$KAFKA_VERSION"

build_kafka-distro() {
    download "https://archive.apache.org/dist/kafka/$KAFKA_VERSION/$KAFKA_PACKAGE.tgz" "$BUILD_DIR/opt/kafka"
    continue $? "could not fetch kafka distro"
    download "https://archive.apache.org/dist/kafka/$KAFKA_VERSION/$KAFKA_PACKAGE.tgz.asc" "$BUILD_DIR/opt/kafka"
    continue $? "could not fetch checksum file for kafka distro"
    echo $KAFKA_PACKAGE > $BUILD_DIR/_check_kafka-distro
}
...
install_kafka-distro() {
    ...
    if [ $? -ne 0 ]; then
        ...
        fail "gpg --verify \"$BUILD_DIR/opt/kafka/$KAFKA_PACKAGE.tgz.asc\" \"$BUILD_DIR/opt/kafka/$KAFKA_PACKAGE.tgz\""
    fi
    ...
    continue $? "could not create /opt/kafka/current link"
}

setup_kafka-distro() {
log "importing apache kafka gpg keys"
gpg --import <<EOFGPG
...
sub   rsa4096 2019-02-22 [S]
sig          48307CB31DCC852D 2019-02-22  Matthias J. Sax <mjsax@apache.org>
...

=HXjr
-----END PGP PUBLIC KEY BLOCK-----
...
uid           [ultimate] Manikumar Reddy Obili (SIGNING KEY) <manikumar.reddy@gmail.com>
sig 3        0DC9AB9E5B3A4458 2018-10-16  Manikumar Reddy Obili (SIGNING KEY) <manikumar.reddy@gmail.com>
sub   rsa4096 2018-10-16 [E]
sig          0DC9AB9E5B3A4458 2018-10-16  Manikumar Reddy Obili (SIGNING KEY) <manikumar.reddy@gmail.com>

-----BEGIN PGP PUBLIC KEY BLOCK-----


...
uid           [ unknown] Colin McCabe <cmccabe@apache.org>
sig 3        DE78987A9CD4D9D3 2015-09-04  Colin McCabe <cmccabe@apache.org>
sub   rsa4096 2015-09-04 [E]
sig          DE78987A9CD4D9D3 2015-09-04  Colin McCabe <cmccabe@apache.org>
...
uid           [ultimate] Bill Bejeck (CODE SIGNING KEY) <bbejeck@gmail.com>
